...
from .views import HomeView, GameOverView, ShowBookmarksView, RegisterView, BookmarkViewSet
...
urlpatterns = [
    ...
    path('view-bookmarks/', ShowBookmarksView.as_view(), name='show-bookmarks'),
